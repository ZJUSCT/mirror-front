...
if cmp -s "yarn.lock" "node_modules/yarn.lock"; then
  ...
  yarn config set sharp_binary_host https://registry.npmmirror.com/-/binary/sharp
  yarn config set sharp_libvips_binary_host https://registry.npmmirror.com/-/binary/sharp-libvips
