...
<ConfigGenerator promptString="请选择您的 Ubuntu 版本：" versionList={Object.keys(ubuntuVersionMap)} defaultVersion={Object.keys(ubuntuVersionMap).findLast(x => x.indexOf("LTS") > 0)} configGen={GenUbuntuConfig} />
