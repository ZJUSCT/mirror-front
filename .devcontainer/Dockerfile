...
RUN su node -c "npm config set sharp_binary_host https://npmmirror.com/mirrors/sharp"
RUN su node -c "npm config set sharp_libvips_binary_host https://npmmirror.com/mirrors/sharp-libvips"
