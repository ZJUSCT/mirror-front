...
本服务设有白名单，仅放行白名单内的镜像。白名单以 [DaoCloud public-image-mirror 项目的 allows.txt](https://github.com/DaoCloud/public-image-mirror/blob/main/allows.txt) 为参考：该列表是已在国内备案、提供 `m.daocloud.io` 镜像服务的公开列表，因此能够确保所放行的镜像合规且安全。

如果你需要拉取的镜像不在白名单中，请前往 [DaoCloud/public-image-mirror](https://github.com/DaoCloud/public-image-mirror) 提交 issue 申请添加。
